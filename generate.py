...
def Create_Robot1():
    ...
    pyrosim.Send_Joint( name = "Link4_Link5" , parent= "Link4" , child = "Link5" , type = "revolute", position = [.5,-.5,0])
    pyrosim.Send_Cube(name="Link5", pos=[0,0,0] , size=[1,1,1])
    pyrosim.Send_Joint( name = "Link5_Link6" , parent= "Link5" , child = "Link6" , type = "revolute", position = [0,-.5,0])
...
#    pyrosim.Send_Cube(name="BackLeg", pos=[0.5,0,.5] , size=[1,1,1]) 
    ...
    pyrosim.Send_Cube(name="FrontLeg", pos=[1.5,0,1.5] , size=[1,1,1])
    pyrosim.End()
